...
public class GameBrowser
{
	...
	void _set_header() {
		...
		if (platform_name != null) {
			...
			font.render_blended(platform_name, selected_item_color).blit(null, screen, platform_rect);
		}

		string folder_id = (current_folder != null) ? current_folder.unique_id().strip() : "";
		if (folder_id != null && folder_id != "") {
			var rendered_folder_id = font.render_blended(folder_id, selected_item_color);
	...
	void show_status_message(string message) {
		...
		font.render_blended(message, selected_item_color).blit(null, screen, rect);
		screen.flip();
	}
