...
{
	public abstract class MenuFontAreaBase<G> : MenuAreaBase<G>, AppearanceFontAreaType<G>
	{
		construct {
			initialize_with_defaults();
		}
		protected MenuFontAreaBase.default() { initialize_with_defaults(); }
