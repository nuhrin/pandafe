...
{
	public class GameBrowserFooter : GameBrowserAreaBase<GameBrowserFooter>
	{	
		construct {
		}
		...
		public override void copy_from(GameBrowserFooter other) {
			copy_font_from(other);
			text_color = other.text_color;
		}
		
		protected override void font_changed() { @interface.game_browser_ui.footer.update_font(this); }
		...
		protected override string get_appearance_description() { return "Game Browser Footer"; }
