...
namespace Data.Appearances
{
	...
	{		
		...
		protected void copy_font_to(AppearanceAreaType other) {
			other.set_font(get_font());
			other.set_font_size(get_font_size());
		}
		protected void copy_font_from(AppearanceAreaType other) {
		...
		// yaml
		protected Yaml.Node build_yaml_node_implementation(Yaml.NodeBuilder builder) {
		...
		protected void apply_yaml_node_implementation(Yaml.Node node, Yaml.NodeParser parser) {
		...
		protected void build_menu_implementation(MenuBuilder builder) {
			...
			build_additional_fields(builder);
